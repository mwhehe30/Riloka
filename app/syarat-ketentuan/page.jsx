      ...
      <div className='prose prose-lg max-w-none'>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-gray-700'>
            <li>
              Anda berusia minimal 18 tahun atau memiliki izin hukum untuk
            ...
            <li>
              Anda setuju untuk tidak melakukan tindakan yang merugikan pengguna
              lain
            </li>
          </ul>
        </section>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-gray-700'>
            ...
            <li>
              Tidak menyebarkan informasi yang menyesatkan atau mencemarkan nama
              baik
            </li>
          </ul>
        </section>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-gray-700'>
            <li>
              Konten tidak melanggar hak kekayaan intelektual pihak ketiga
            </li>
            <li>
              Konten tidak mengandung informasi yang menyesatkan atau tidak
              akurat
            </li>
            <li>
              Konten tidak mengandung konten yang tidak senonoh, menghina, atau
              menakutkan
            </li>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2 text-gray-700'>
            <li>
              Keakuratan informasi yang disediakan oleh UMKM atau pengguna
            </li>
        ...
        <section className='mb-8'>
          ...
          <p className='text-gray-700 mb-4'>
            ...
            Perubahan akan diumumkan di website kami dan tanggal diperbarui akan
            ditampilkan di atas. Penggunaan layanan setelah perubahan berarti
            Anda menerima syarat dan ketentuan yang baru.
          </p>
        </section>
